...
/**
 module.exports = {
  ...
  rules: {
    ...
    // Zod 相关规则，可根据实际情况添加更多
    "no-unused-vars": ["error", { "argsIgnorePattern": "^_" }],
    // Ant Design 相关规则，可根据实际情况添加更多
        ...
        patterns: [
          {
            group: ["~/localization/*"],
            message:
              "Don't import any internals from a module, only use its public api",
          },
        ],
      },
    ...
    "import/no-useless-path-segments": [
      // 防止在 import 和 require 语句中出现不必要的路径段"error",
      { noUselessIndex: true },
    ],
