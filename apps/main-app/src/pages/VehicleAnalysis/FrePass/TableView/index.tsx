...
export type TableViewProps = {
  ...
  onGroupFilterChange?: (data: GroupFilterCallBackType, item?: FrePassItem) => void;
};
const TableView: React.FC<TableViewProps> = (props) => {
  ...
  const columns: ColumnProps<FrePassItem>[] = [
    {
      title: "序号",
      dataIndex: "number",
      render: (_, __, index) => {
    ...
    },
    {
      ...
      render(col, item, index) {
        if (!item.groupCount?.remainingCount) return "-";
        return (
          <span
            className=""
            onClick={() => {
