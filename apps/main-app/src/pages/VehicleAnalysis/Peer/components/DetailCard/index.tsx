...
export default function DetailCard (props: DetailCardType<{ target: ResultRowType, peer: ResultRowType, index?: number }>) {
  const {
    cardData,
    ...
    >
      ...
      <div className="item-img">
        <div className="car-common">
          <span className="car-common-title">{signs[0]}</span>
        ...
        <div className="car-common">
          <span className="car-common-title">{signs[1]}</span>
