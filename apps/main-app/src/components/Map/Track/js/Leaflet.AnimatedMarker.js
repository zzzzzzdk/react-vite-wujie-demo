...
L.AnimatedMarker = L.Marker.extend({
  ...
  resetIcon: function () {
    ...
    var Icon = L.DivIcon.extend({
      createIcon: function () {
        ...
        outerDiv.style.zIndex = "9999 !important"
  ...
  setSpeetX: function (_speetX) {
    ...
    if(_speetX !== this.options.speetX) {
      this.restart()
    }
  ...
  setI: function (i) {
    ...
    if (i == -1) {
      var lat = this._latlngs[this._latlngs.length - 1].lat
      var lng = this._latlngs[this._latlngs.length - 1].lng
