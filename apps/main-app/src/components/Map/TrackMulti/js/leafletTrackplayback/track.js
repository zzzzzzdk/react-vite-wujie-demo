...
export const Track = L.Class.extend({
  ...
  _update: function () {
    // 数组长度32944，时间过长，前端不能排序
    // console.time("_sortTrackPointsByTime")
    // this._sortTrackPointsByTime() // _sortTrackPointsByTime: 83710.587890625 ms 
    // console.timeEnd('_sortTrackPointsByTime')

    console.time('_updatetimeTick')
    this._updatetimeTick()
    console.timeEnd('_updatetimeTick')
  },
