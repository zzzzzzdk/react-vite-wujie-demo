...
export class Flv extends EventEmitter {
  ...
  _onProgress = async (chunk, done, { startTime, endTime, st, firstByteTime }, response) => {
    // console.log('_onProgress', chunk, done, { startTime, endTime, st, firstByteTime }, response)
    this._loading = !done
    ...
    // if (chunk) {
    // console.log(this._opts.bufferBehind, 'this._opts.bufferBehind')
    // console.log(this._opts.softDecode, 'this._opts.softDecode')
    try {
