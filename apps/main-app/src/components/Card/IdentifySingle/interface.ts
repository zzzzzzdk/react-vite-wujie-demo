 ...
 */
  ...
  */
  ...
  /**
   * @description 是否显示加入过滤名单按钮
   * @default true
   */
  showAddFilterate?: boolean;
  /**
   * @description 是否悬浮显示删除按钮
   * @default false
   */
  showDelBtn?: boolean;
  onDelClick?: (data: any) => void;
  /**
  ...
  /**
   * @description 是否显示步态数量
   * @default true
   */
  showGaitFeature?: boolean;
}